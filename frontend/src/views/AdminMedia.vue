  ...
  <div class="admin-media-page">
    <div class="page-header">
      ...
      <p class="page-description">
        Upload and manage images and media files for your articles and content.
      </p>
    </div>
    ...
    <div class="tab-content">
      ...
      <div v-if="activeTab === 'upload'" class="upload-section">
        <div class="section-header">
          <h2>Upload Media</h2>
          <p>Upload images to use in your articles and content. Supported formats: JPEG, PNG, GIF, WebP, SVG.</p>
        </div>
...
function handleMediaUpdated(media) {
