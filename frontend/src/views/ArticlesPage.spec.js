...
const mockArticles = [
  { id: 1, title: 'Article 1', slug: 'article-1', excerpt: 'Excerpt 1', tags: [] },
  { id: 2, title: 'Article 2', slug: 'article-2', excerpt: 'Excerpt 2', tags: [] }
]
...
describe('ArticlesPage', () => {
  ...
  it('fetches and displays articles', async () => {
    ...
    expect(axios.get).toHaveBeenCalledWith('/api/articles', expect.any(Object))
