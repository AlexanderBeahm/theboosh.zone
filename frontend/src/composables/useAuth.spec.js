...
describe("useAuth Composable", () => {
    ...
    describe("logout()", () => {
        ...
        it("redirects to login page after logout", async () => {
            ...
            // Spy on router.push to verify it's called correctly
        ...
        it("supports custom redirect path", async () => {
            ...
            // Spy on router.push to verify custom path
            const pushSpy = vi.spyOn(router, "push");
    ...
    describe("requireAuth()", () => {
        ...
        it("returns false and redirects to login when not authenticated", async () => {
            ...
            // Spy on router.push to verify redirect
            const pushSpy = vi.spyOn(router, "push");
        ...
        it("supports custom redirect path", async () => {
            ...
            // Spy on router.push to verify custom redirect
            const pushSpy = vi.spyOn(router, "push");
