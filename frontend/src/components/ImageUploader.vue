  ...
  <div class="image-uploader">
    ...
    >
      ...
      <div v-if="previewUrl" class="preview-container">
        <img :src="previewUrl" :alt="altText || 'Preview'" class="preview-image" />
        <button
          v-if="!isUploading"
          type="button"
          class="remove-button"
    ...
    <!-- Metadata Inputs -->
    <div v-if="previewUrl && showMetadata" class="metadata-inputs">
...
function processFile(file) {
  ...
  if (!allowedTypes.includes(file.type)) {
    error.value = 'Invalid file type. Please upload an image file (PNG, JPG, GIF, WEBP, or SVG).'
    return
  }
